...
export function FeaturesSection() {
	return (
		<section id="features" className="bg-[#080C12] py-28">
			<div className="mx-auto max-w-5xl px-6">
				<div className="mb-20 text-center">
					...
					<h2 className="mt-1 bg-gradient-to-r from-[#7C3AED] to-[#4F8EF7] bg-clip-text text-[32px] font-bold text-transparent md:text-[40px]">
						Not how they type.
					</h2>
				</div>

				<div className="grid grid-cols-12 gap-4">
					<div className="relative col-span-12 overflow-hidden rounded-2xl border border-white/8 bg-[#0D1117] p-8 md:col-span-7 md:row-span-2">
						<div className="pointer-events-none absolute bottom-0 right-0 h-48 w-48 rounded-full bg-[#7C3AED]/10 blur-3xl" aria-hidden />
						<div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#7C3AED]/15">
							<IconMic className="h-5 w-5 text-[#7C3AED]" />
						</div>
						...
						<div className="mt-6 rounded-xl border border-white/5 bg-[#070A0F] p-4">
							<div className="flex h-10 items-end gap-1">
								{[12, 18, 24, 28, 20, 14, 22, 16, 26, 18, 12, 20, 24, 16, 10, 22].map((h, i) => (
									<div key={i} className="w-1 rounded-full bg-[#7C3AED]" style={{ height: `${h}px` }} />
								))}
							</div>
					...
					<div className="col-span-12 rounded-2xl border border-white/8 bg-[#0D1117] p-6 md:col-span-5">
						<div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#10B981]/10">
							<IconSparkles className="h-5 w-5 text-[#10B981]" />
						</div>
						...
						<div className="mt-4 space-y-1 font-mono text-xs text-white/40">
							<p>📁 src/</p>
							<p>
								&nbsp;&nbsp;📄 <span className="text-[#10B981]">components/UserCard.tsx</span>
							</p>
							<p>
								&nbsp;&nbsp;📄 lib/auth.ts
							</p>
					...
					<div className="col-span-12 rounded-2xl border border-white/8 bg-[#0D1117] p-6 md:col-span-5">
						<div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#4F8EF7]/10">
							<IconCode2 className="h-5 w-5 text-[#4F8EF7]" />
						</div>
					...
					<div className="col-span-12 flex flex-col items-stretch justify-between gap-8 rounded-2xl border border-white/8 bg-gradient-to-r from-[#0D1117] to-[#0A0E14] p-8 md:flex-row md:items-center">
						<div className="max-w-md">
							<div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#7C3AED]/10">
								<IconKeyboard className="h-5 w-5 text-[#7C3AED]" />
							</div>
						...
						<div className="flex shrink-0 gap-1 rounded-xl border border-white/8 bg-[#070A0F] p-1">
							<button
								type="button"
								className="flex items-center gap-2 rounded-lg bg-[#7C3AED] px-4 py-2 text-sm font-medium text-white"
							>
