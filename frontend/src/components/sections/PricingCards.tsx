...
const tiers = [
	{
		...
		period: '/mo',
		features: [
			'3 AI hires on your team',
			'1 new voice agent / month',
			'Premium voice + memory',
			'CLI access',
		],
	...
	},
	{
		...
		period: '/mo',
		features: [
			'6 AI hires on your team',
			'3 new voice agents / month',
			'Everything in Basic',
			'Priority support',
		],
		cta: 'Configure your team',
	...
	},
	{
		...
		period: '/mo',
		features: [
			'9 AI hires on your team',
			'6 new voice agents / month',
			'Everything in Pro',
			'Higher throughput',
		],
		cta: 'Configure your team',
	...
	},
	{
		...
		period: '/mo',
		features: [
			'24 AI hires on your team',
			'12 new voice agents / month',
			'Marketplace publishing + payouts',
			'Admin controls + shared vault',
		],
		cta: 'Configure your team',
	...
	},
	{
		...
		features: [
			'350 AI hires (per contract)',
			'New voice agents: Custom (per contract)',
			'SSO + audit + SLA',
			'Dedicated support',
		],
		cta: 'Talk to us',
