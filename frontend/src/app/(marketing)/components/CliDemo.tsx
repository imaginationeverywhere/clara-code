...
export function CliDemo() {
	...
	return (
		<div className="relative mx-auto mt-8 max-w-5xl px-4">
			<div className="pointer-events-none absolute left-1/2 top-1/2 -z-10 h-[400px] w-[600px] -translate-x-1/2 -translate-y-1/2 bg-[#7C3AED]/8 blur-[80px]" />

			<div className="flex flex-wrap items-start justify-center gap-4">
				{/* Window 1 — install */}
				<div
					className="w-[420px] min-w-[300px] overflow-hidden rounded-2xl border border-white/8 bg-[#09090F] shadow-[0_40px_80px_rgba(0,0,0,0.6)]"
					aria-hidden
				>
					<div className="flex h-10 items-center border-b border-white/6 bg-[#13141A] px-4">
...
└─────────────────────────────────┘`}</pre>
				...
				{/* Window 2 — TUI */}
				<div
					className="w-[580px] min-w-[320px] overflow-hidden rounded-2xl border border-white/8 bg-[#09090F] shadow-[0_40px_80px_rgba(0,0,0,0.6)]"
					aria-hidden
				>
					<div className="flex h-9 items-center justify-between border-b border-white/8 bg-[#0A0E14] px-4">
						<div className="flex items-center gap-4">
							<div className="flex items-center gap-4">
								...
								<span className="font-mono text-[13px] font-semibold text-[#7BCDD8]">Clara</span>
						...
						<div className="flex items-center gap-4">
							...
							<span className="rounded-md border border-[#7C3AED]/20 bg-[#7C3AED]/10 px-1.5 py-0.5 font-mono text-[11px] text-[#7C3AED]">
								Pro
							</span>
							<span className="text-white/20">·</span>
					...
					<div className="relative min-h-[320px] bg-[#09090F] p-0 pb-8 font-mono text-[13px] leading-7">
						<div className="p-5">
							...
							<div className="text-[13px] leading-7 text-white/20">
								...
								<p>│ │</p>
								<p>
									│ <span className="text-[#7C3AED]">export default</span> <span className="text-[#7C3AED]">function</span>{" "}
								...
								<p>
									│ <span className="text-white/45"> </span>
									<span className="text-[#7C3AED]">return</span> <span className="text-white/45">(</span> │
								</p>
								<p>
									│ <span className="text-[#7BCDD8]">&lt;div</span> <span className="text-[#FBBF24]">className</span>
								...
								<p>
									│ <span className="text-white/45"> </span>
									<span className="text-[#7BCDD8]">&lt;Skeleton</span> <span className="text-[#FBBF24]">className</span>
									<span className="text-white/85">=</span>
									<span className="text-[#10B981]">&apos;h-8 w-48&apos;</span> <span className="text-white/45">/&gt;</span> │
								</p>
								<p>
									│ <span className="text-white/45"> </span>
									<span className="text-[#7BCDD8]">&lt;Skeleton</span> <span className="text-[#FBBF24]">className</span>
									<span className="text-white/85">=</span>
									<span className="text-[#10B981]">&apos;h-32 w-full&apos;</span> <span className="text-white/45">/&gt;</span> │
								</p>
								<p>
									│ <span className="text-white/45"> </span>
						...
						<div className="absolute bottom-0 flex h-8 w-full items-center gap-6 border-t border-white/6 bg-[#050509] px-4">
