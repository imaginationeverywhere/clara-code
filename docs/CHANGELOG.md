...
- **`.gitignore`** — ignore `desktop/shell/voice-converse-bundled.js` (generated by `build:shell-voice` on branches that have that script; keeps a clean `git status`). See root `CHANGELOG.md` **\[Unreleased\] - 2026-04-25**.
