...
**Related:** Token summary and Tailwind mapping live in [`docs/design-system.md`](./design-system.md). Paste the sections below into each area of your **Clara Code** design system on Magic Patterns.
